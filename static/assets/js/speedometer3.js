...
function speedometer6(userPref){
    this._speedometerProperty = {
      id                  : 'speedometer-cnt-' + Math.floor(Math.random() * 100000) + 1,  
                            /**Speedometer container id*/
                            maxVal              : max,                /**Max value of the meter*/
                            divFact             : 2,                 /**Division value of the meter*/
                            // dangerLevel         : 120,                /**more than this leval, color will be red*/
                            
                            dangerStart         : batteryunderVoltage,

                            dangerEnd           : batteryOverVoltage,
   ...
   * })
   */
  speedometer6.prototype._createElm = function(metedata) {
  ...
  speedometer6.prototype._setCssProperty = function() {
  ...
  speedometer6.prototype._createIndicators = function(){
  ...
  speedometer6.prototype.setPosition = function (speed){   
