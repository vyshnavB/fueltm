...
function speedometer5(userPref){
    this._speedometerProperty = {
      id                  : 'speedometer-cnt-' + Math.floor(Math.random() * 100000) + 1,  
                                                /**Speedometer container id*/
      maxVal              : 60,                /**Max value of the meter*/
      divFact             : 5,                 /**Division value of the meter*/
      dangerLevel         : 80,                /**more than this leval, color will be red*/


      dangerStart         : underFrequency,

      dangerEnd           : overFrequency,
      ...
      gagueLabel          : 'Hz',             /**Label on guage Face*/	
   ...
   * })
   */
  speedometer5.prototype._createElm = function(metedata) {
  ...
  speedometer5.prototype._setCssProperty = function() {
  ...
  speedometer5.prototype._createIndicators = function(){
  ...
  speedometer5.prototype.setPosition = function (speed){   
