...
// function myFunction1(underVoltage, overVoltage) {
//   console.log("underVoltage 1 is: " + underVoltage);
//   console.log("overVoltage is: " + overVoltage);
...
function speedometer4(userPref){
    this._speedometerProperty = {
      id                  : 'speedometer-cnt-' + Math.floor(Math.random() * 100000) + 1,  
                                                /**Speedometer container id*/
      maxVal              : max2,                /**Max value of the meter*/
      divFact             : 25,                 /**Division value of the meter*/
      dangerLevel         : 500,                /**more than this leval, color will be red*/

      
      dangerStart         : underVoltage,

      dangerEnd           : overVoltage,
      ...
      gagueLabel          : 'Volt',             /**Label on guage Face*/	
      
      initVal             : 0,                  /**Initial value*/

      dangerColor         : '#049616 ',          /**Danger speed color (red)*/
      ...
      nobNumbColor        : '#FF113A',            /**Indicator Nob number color around circle */
  ...
  // var value12 = window.underVoltage;
  // console.log(value12);
   ...
   * })
   */
  speedometer4.prototype._createElm = function(metedata) {
  ...
  speedometer4.prototype._setCssProperty = function() {
  ...
  speedometer4.prototype._createIndicators = function(){
    ...
    for(var i=0; i<=this._noOfDev; i++) {
      ...
      var isDanger = curIndVal >= this._speedometerProperty.dangerStart && curIndVal <= this._speedometerProperty.dangerEnd;

      
      var dangCls = isDanger ? "danger" : "";
  ...
  speedometer4.prototype.setPosition = function (speed){   
